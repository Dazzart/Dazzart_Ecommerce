...
export default function ProductoDetalle({
  ...
  useEffect(() => {
    ...
    const fetchProducto = async () => {
      try {
        const res = await API.get(`productos/${params.id_producto}`);
        const data = res.data;
        const urlImagen = imgUrl(data.imagen);
    ...
    <>
      ...
      <div className="container mt-5" style={{ marginBottom: '6rem', position: 'relative', zIndex: 1 }}>
        ...
        <div className="row g-4 g-md-5">
          <div className="col-12 col-md-6 d-flex justify-content-center align-items-center" style={{ minHeight: '350px', backgroundColor: '#f5f9ff', borderRadius: '8px', padding: '15px' }}>
            <img
          ...
          <div className="col-12 col-md-6">
            ...
            <div className="d-flex gap-2 gap-md-3 flex-column flex-sm-row mb-4">
              <button
              ...
              <button
                className="btn btn-outline-primary px-4 w-100 w-sm-auto"
